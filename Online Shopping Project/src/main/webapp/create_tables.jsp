<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
 ...
 <%
    try{
    	 ...
    	 String q1 = "create table users(name varchar(100), email varchar(100)primary key,mobileNumber bigint,securityQuestion varchar(200),answer varchar(200),password varchar(10),address varchar(500),city varchar(100),state varchar(100),country varchar(100))";
