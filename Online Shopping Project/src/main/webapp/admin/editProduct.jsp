<%@page import="project.ConnectionProvider" %> 
 ...
 <%@include file="adminHeader.jsp" %><%--automatically add page --%>
...
try{
	...
	ResultSet rs=st.executeQuery("select * from  product where id='"+id+"'");//edit krna ona product id ekta adla data labaganima
    while(rs.next())
    {
